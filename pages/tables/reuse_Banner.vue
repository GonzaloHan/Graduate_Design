      ...
      <a-layout :style="{ marginLeft: '200px',top:'15px'}">
        <a-layout-content :style="{ margin: '85px 20px 0', overflow: 'initial' }">
          <div :style="{ padding: '16px', background: '#fff', textAlign: 'center',height:'568px' }">
            <a-row>
              <span class="labelhead" >Banner样式配置</span>
              <br><br>
            </a-row>
            <a-row>
                    ...
                    <a-row style="width: 336px">
                      <draggable
                        ...
                        <img
                                ...
                                style="margin-top: 12px;width:312px; height:150px;border-radius: 20px; border:dashed 2px #4f99ff;float: left"/>
                      </draggable>
                    </a-row>
                  </a-row>
                </a-drawer>
                <!--预览-->
                <div style="width:500px ; height:240px;border-radius: 20px; border:dashed 2px #4f99ff;margin-left: 395px;margin-top: 60px;padding: 18px">
                  <a-row style="margin-left: -20px;margin-top: -20px">
                    <draggable
                      ...
                      <img
                              ...
                              :key="element.address"
                              :src="require('../../assets/'+element.address)"
                              style="width:502px; height: 242px; border-radius: 20px;float: left; border:dashed 2px #4f99ff;"
                      />
                    </draggable>
                  </a-row>
                </div>
  ...
  export default {
    ...
    data() {
      return{
        ...
        left_it:0,
        list_logo_pull:[
          {address:'Banner_01.png', id:1 },
          {address:'Banner_02.png', id:2 },
          {address:'Banner_03.png', id:3 },
          {address:'Banner_04.png', id:4 },
        ],
        list_logo_push:[
          {address:'empty_banner.png', id:1}
        ],
      };
    },
